...
Lock](https://github.com/laithserhan/link-lock). This static, distributed web
...
editor](http://laithserhan.github.io/urlpages/editor).
...
- A page with embedded images (no external image host)
    - Code in the code editor
      [here](http://laithserhan.github.io/urlpages/examples/embed-code.html)
    - "Published" page
      [here](http://laithserhan.github.io/urlpages/examples/embed-page.html)

The following examples were cloned from existing pages using the bookmarklet.

- My dad's food blog
  [here](http://laithserhan.github.io/urlpages/examples/food-blog.html)
- The entire [editor](http://laithserhan.github.io/urlpages/editor) encoded in the
  URL [here](https://tinyurl.com/y6nx5347)
- This GitHub project page
  [here](http://laithserhan.github.io/urlpages/examples/project-page.html)
- A cloned New York Times Article
  [here](http://laithserhan.github.io/urlpages/examples/nyt.html)
...
[`bookmarklet.js`](https://github.com/laithserhan/urlpages/blob/master/bookmarklet.js).
...
- Add option to "publish" pages using base65536 as suggested
  [here](https://github.com/laithserhan/urlpages/issues/5)
